...
public class Administrador extends javax.swing.JFrame {
    ...
    public Administrador() {
        ...
        try {
            ...
            "select nombre_usuario from usuarios where userme = '" + user +  "'");
    ...
    private void initComponents() {
        ...
        nom_usuario.setFont(new java.awt.Font("Arial Black", 0, 14)); // NOI18N
        nom_usuario.setText("Administrador");
