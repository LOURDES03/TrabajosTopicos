...
public class login extends javax.swing.JFrame {
    ...
    private void accederActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_accederActionPerformed
        ...
        //contraseña
        if(user.equals("Admi")&& pass.equals("Admi")){
        ...
        //
           ...
           /* try {
                ...
                if(rs.next()){
                    ...
                    } else if(tipo_nivel.equals("Capturador") && estatus.equalsIgnoreCase("Activo")){
                     
                        dispose();
                        new Capturador().setVisible(true);
                        
                    }else if(tipo_nivel.equals("Visualizadorr") && estatus.equalsIgnoreCase("Activo")){
